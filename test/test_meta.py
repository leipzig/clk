...
class TypeLookup(unittest.TestCase):
    ...
    def testlookup(self):
        self.assertEqual(metautils.getRunsFromSampleName('untreated'),['SRR5009496', 'SRR5009521', 'SRR5009474', 'SRR5009406'])
    def test_manifest(self):
        metautils.twoSampleComparisonManifest('Untreated HCT116','0.1 uM T3 treated HCT116','unvs01.txt')
        metautils.twoSampleComparisonManifest('Untreated','Treated','uvst.txt')
def main():
    unittest.main()
