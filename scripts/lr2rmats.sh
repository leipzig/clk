...
mkdir GRCh38_star
echo "download genes..."
aws s3 cp s3://clk-splicing/refs/GRCh38/Sequence/STARIndex/genes.gtf GRCh38_star/genes.gtf
echo "download sam..."
aws s3 cp s3://clk-splicing/${project}/${sample}.sam .
echo "download rRNA gtf"
#http://onetipperday.sterding.com/2012/02/get-rrnagtf-file-from-ucsc-table.html
aws s3 cp s3://clk-splicing/refs/GRCh38/Sequence/STARIndex/rRNA_tx.gtf GRCh38_star/rRNA_tx.gtf 
